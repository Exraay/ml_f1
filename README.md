...
![Model comparison MAE vs RMSE](reports/model_comparison_mae_rmse.png)

**Cumulative error distribution (2025 test)**
![Cumulative error distribution](reports/cumulative_error_distribution.png)

**Accuracy within thresholds**
![Accuracy thresholds](reports/accuracy_thresholds.png)

**MAE by round (2025, all models)**
![MAE by round 2025](reports/mae_by_round_2025.png)

**XGBoost feature importance (top 20)**
![XGBoost feature importance](reports/feature_importance_xgboost.png)
